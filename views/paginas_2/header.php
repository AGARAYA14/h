  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <span class="dropdown-item dropdown-header">1 Notificaciones</span>
        ...
        <a href="index.php?pagina=reservas&not=0" class="dropdown-item">
          ...
          <span class="badge badge-info ">1 Reservas nuevas</span>
        ...
        <a href="index.php?pagina=testimonios&not=0" class="dropdown-item">
          ...
          <span class="badge badge-info ">1 Testimonios nuevos</span>
